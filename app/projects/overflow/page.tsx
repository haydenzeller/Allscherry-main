...
export const metadata: Metadata = {
  ...
  description:
    "AllsCherry Overflow Page - Overflow is a book of discovery, mystery, colourful underwater lands, and a complicated series of historical events.",
  keywords: [
    "AllsCherry",
    "Home",
    "AllsCherry Home",
        ...
        <section className="flex flex-col items-center justify-center">
          <div className="flex flex-col items-center justify-center relative">
            <Image
              ...
              width={500}
              height={500}
              className="w-screen h-auto pt-5 pb-5"
            />
            <Image
              src={ofPageEx}
              alt="Overflow Page Example"
              width={500}
              height={500}
            ...
            <h1 className="border border-base-200 rounded-3xl p-3 w-3/4 mt-6 text-center">
              ...
              <br />
              <br />
              Four creatures find a whole world under their feet, one of true
              beauty. So many colours, so many creatures, and so much unexplored
              territory! What awaits these four brave souls deep beneath?
            </h1>
          </div>
          <div className="flex flex-row items-center justify-center mt-6 gap-0">
            <Image
              src={overflowCover}
              alt="Overflow Cover"
              width={500}
              height={500}
              className="w-32 h-32 rounded-tl-3xl rounded-bl-3xl"
            />
            <div className="flex flex-col items-center justify-center bg-base-200 h-32 w-32">
              <h2>Coming Soon!</h2>
            </div>
            <div className="flex flex-col items-center justify-center bg-base-200 rounded-tr-3xl rounded-br-3xl h-32 w-32">
              <h2>Coming Soon!</h2>
            </div>
          </div>
        ...
        <section className="flex flex-col items-center justify-center mt-6">
          <div className="flex flex-col items-center justify-center relative mx-3">
            ...
            <h2 className="border border-base-200 rounded-3xl p-3 w-10/12 mt-6 text-center">
              ...
              <br />
              <br />
              An incredibly long time after Wendy and the Sprite, a world above
              water is enveloped in a black and white landscape, one of a dull
              and lifeless experience. These four creatures seek adventure, and
              they sure as heck find some!
            </h2>
          </div>
          {/* 4x4 */}
          ...
          <div className="flex flex-col items-center justify-center mt-6 mx-4">
            ...
            <p className="border border-base-200 rounded-3xl p-3 w-10/12 mt-6 text-center">
              ...
              don&apos;t speak, Overflow gave Eric an opportunity to write with
              more dialogue, and see how this can work in his comic formats!
              <br />
              <br />
              This new landscape, creatures, and plot line also gave a lot of
              opportunity for lore building. Since the book is set so far in the
              future, a lot has changed. What do the events of Wendy and the
              Sprite have to do with this plot I wonder?
            </p>
          </div>
          ...
          <h2 className="border border-base-200 rounded-3xl p-3 w-10/12 mt-6 text-center">
            Overflow, now opening many avenues for lore and character building,
            gave Eric another new idea for a book, Dot the Robot. We know the
            present (Wendy), we know the future (Overflow), but what about the
            planet&apos;s past?
          </h2>
          <Link
            className="bg-primary mt-3 text-black p-1 border-b-accent border-b-4 rounded-2xl block w-32 text-center active:mt-4 active:border-0"
