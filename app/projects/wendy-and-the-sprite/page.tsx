            ...
            <main className="flex min-h-screen flex-col bg-base-100 md:hidden">
                ...
                <section>
                    <div className="flex flex-col items-center justify-center mt-14">
                        ...
                        <h2 className="w-3/4 text-md text-center mt-6">
                            Wendy and the Sprite is the adventure of a Snow Nymph and an Ice Sprite, traversing a old, frozen planet. Along their adventure, they discover a phenomenon called, “The Fading”, making the planet and it&apos;s inhabitants lose their colour and memory.
                        </h2>
                        <div className="flex flex-row gap-3 mt-6">
                            <Image src={wats0} alt="Wendy and the Sprite Chapter 0" width={125} height={300} className="rounded-box h-auto w-auto "/>
                            <Image src={wats1} alt="Wendy and the Sprite Chapter 1" width={125} height={300} className="rounded-box h-auto w-auto "/>
                            <Image src={wats2} alt="Wendy and the Sprite Chapter 2" width={125} height={300} className="rounded-box h-auto w-auto "/>
                        </div>
                        <h2 className="mt-6">Check out the series here!</h2>
                ...
                <section>
                    <div className="flex flex-row justify-center items-center gap-3 text-center mx-3 mt-14">
                        <Image src={watsBackstorySketch} alt="Wendy and the Sprite Backstory Sketch" width={200} height={200} className="rounded-box"/>
                        <h2>The Wendy and the Sprite series started as a post-secondary animation project. With the characters in mind, Eric made an animation that would ultimately become Chapter 1: Awakening</h2>
                    </div>
