                    ...
                    <li className="flex justify-center">
                        <div className="dropdown dropdown-end gap-4">
                            ...
                            <ul tabIndex={0} className="text-black dropdown-content mt-1 p-2 bg-primary border-4 border-accent rounded-box w-52 shadow-right-bottom z-50 flex flex-col">
                                ...
                                <Link href="/publishing/collaboratives" className="hover:bg-white p-2 rounded-2xl w-full">Collaboratives</Link>
                                <Link href="/applications" className="hover:bg-white p-2 rounded-2xl w-full">Applications</Link>
                            </ul>
                        </div>
                    </li>
                    </ul>
        ...
        <section className="flex-col items-center text-2xl justify-center hidden lg:flex min-w-screen ">
            ...
            <div className="w-screen flex bg-base-100 z-10 flex-col items-center justify-center">
                <Link href="/" className="flex flex-col items-center justify-center"> 
                    <Image priority className="w-80 -mt-44" src={allscherryLogo} alt="Allscherry Logo"/>
                </Link>
            </div>
            <div className="flex w-screen -mt-24 flex-row items-center gap-96 justify-center bg-base-100">            
                <div className="flex flex-row items-center justify-self-center mr-52">
                    <ul className="grid grid-cols-2 grid-rows-2 gap-40 z-10">
                        <li className="flex justify-center ">
                            <div className="dropdown gap-4">
                                <div tabIndex={0} role="button" className="bg-primary text-black p-1 border-b-accent border-b-4 rounded-2xl block w-40 text-center active:mt-1 active:border-0" >
                                    Projects
                                </div>
                                <ul tabIndex={0} className="text-black dropdown-content mt-1 p-2 bg-primary border-4 border-accent rounded-box w-52 shadow-right-bottom z-50 flex flex-col">
                                    <Link href="/projects/wendy-and-the-sprite" className="hover:bg-white p-2 rounded-2xl w-full">Wendy and the Sprite</Link>
                        ...
                        <li className="flex justify-center">
                            <div className="dropdown dropdown-end gap-4">
                                <Link href="https://shop.allscherry.com/" tabIndex={0} role="button" className="bg-primary text-black p-1 border-b-accent border-b-4 rounded-2xl block w-40 text-center active:mt-1 active:border-0" >
                                    Shop
                                </Link>
                                {/* <ul tabIndex={0} className="text-black dropdown-content z-10 mt-1 p-2 bg-primary border-4 border-accent rounded-box w-52 shadow-right-bottom">
                                </ul> */}
