      ...
      <section className="flex flex-col bg-base-200 w-full">
        ...
        <div className="flex flex-row justify-center items-center gap-2 mb-3">
          <div className="flex flex-row items-center justify-center">
            <Link
              href="https://linktr.ee/eolcsvary_art"
              target="_blank"
              className="gap-3 flex flex-row-reverse items-center jsutify-center text-lg"
            >
              <Image
          ...
          <div className="flex flex-row items-center justify-center">
            <Link
              href="https://www.facebook.com/allscherry/"
              target="_blank"
              className="gap-3 flex flex-row items-center jsutify-center text-lg text-base-100"
            >
              <Image
          ...
          <div className="flex flex-row items-center justify-center">
            <Link
              href="https://www.instagram.com/eolcsvary_art/"
              target="_blank"
              className="gap-3 flex flex-row items-center jsutify-center text-lg"
            >
              <Image
                className=""
                src={instagramLogo}
        ...
        <div className="flex flex-row justify-center items-center m-1 gap-5">
          ...
          <Link href="/legal/copyright" className="underline">
            Copyright
          </Link>
        </div>
        <div className="flex justify-center items-center my-4">
          <p className="opacity-70 text-sm">
            Copyright &copy; 2022-{currentYear}, AllsCherry. All Rights
            Reserved.
          </p>
        </div>
      </section>
