  ...
  return (
    <>
      <section className="lg:hidden">
        <div className="mt-10 flex lg:hidden flex-row gap-2 justify-center items-center">
          {showOrbs && <div className="bg-white w-12 h-12 rounded-full" />}
          <input
            className="rounded-2xl input w-60 bg-white input-md text-black text-center"
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <div className="absolute mt-24">
            {showSuccess && (
              <p className="text-success">Subscribed :) Thanks!</p>
            )}
            {showError && (
              <p className="text-error">Sorry, email is invalid!</p>
            )}
      ...
      {/* desktop */}
      {/* copy above but bigger  */}
      <section className="hidden lg:flex flex-col mt-12 gap-2 justify-center items-center">
        <div className="flex flex-row gap-2 justify-center items-center">
          {showOrbs && <div className="bg-white w-12 h-12 rounded-full" />}
          <input
            className="rounded-2xl input w-80 h-14 text-xl bg-white input-md text-black text-center"
            placeholder="Subscribe for Updates!"
            onChange={(e) => {
              setEmail(e.target.value);
              setShowError(false);
