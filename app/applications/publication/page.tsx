        ...
        >
          ...
          <div className="flex flex-col items-center justify-center mt-6 text-center">
            <div className="bg-white text-black flex flex-row items-center justify-left pl-5 rounded-3xl w-1/2 py-2">
              ...
              />
              <label htmlFor="illustrator" className="mr-8">
                Illustrator
              </label>
            </div>
            <div className="w-1/2 bg-white text-black flex flex-row items-center justify-left pl-5 mt-6 rounded-3xl py-2">
              <input
                ...
                className=" appearance-none w-5 h-5 mr-5 rounded-full border-2 border-base-100 checked:bg-base-100"
              />
              <label htmlFor="inker" className="mr-8">
                Inker
              </label>
            </div>
            <div className="w-1/2 bg-white text-black flex flex-row items-center justify-left pl-5 mt-6 rounded-3xl py-2">
              <input
                ...
                className=" appearance-none w-5 h-5 mr-5 rounded-full border-2 border-base-100 checked:bg-base-100"
              />
              <label htmlFor="colourist" className="mr-8">
                Colourist
              </label>
            </div>
            <div className="w-1/2 bg-white text-black flex flex-row items-center justify-left pl-5 mt-6 rounded-3xl py-2">
              <input
                ...
                className=" appearance-none w-5 h-5 mr-5 rounded-full border-2 border-base-100 checked:bg-base-100"
              />
              <label htmlFor="writer" className="mr-8">
                Writer
              </label>
            </div>
          ...
          <h2 className="mt-12 bg-white rounded-xl p-3 text-center text-black w-3/4">
            *What will you publish with AllsCherry?
          </h2>
          <div className="flex flex-col items-center justify-center mt-6 text-center w-full">
            ...
            <div className="bg-white text-black flex flex-row items-center justify-left pl-5 rounded-3xl w-1/2 py-2">
              <input
                ...
                className=" appearance-none w-5 h-5 mr-5 rounded-full border-2 border-base-100 checked:bg-base-100"
              />
              <label htmlFor="comicBook" className="mr-8">
                Comic Book
              </label>
            </div>
            {/* Graphic Novel */}
            <div className="w-1/2 bg-white text-black flex flex-row items-center justify-left pl-5 mt-6 rounded-3xl py-2">
              <input
                ...
                className=" appearance-none w-5 h-5 mr-5 rounded-full border-2 border-base-100 checked:bg-base-100"
              />
              <label htmlFor="graphicNovel" className="mr-8">
                Graphic Novel
              </label>
            </div>
            {/* Manga */}
            <div className="w-1/2 bg-white text-black flex flex-row items-center justify-left pl-5 mt-6 rounded-3xl py-2">
              <input
                ...
                className=" appearance-none w-5 h-5 mr-5 rounded-full border-2 border-base-100 checked:bg-base-100"
              />
              <label htmlFor="manga" className="mr-8">
                Manga
              </label>
            </div>
            {/* Collaborative */}
            <div className="w-1/2 bg-white text-black flex flex-row items-center justify-left pl-5 mt-6 rounded-3xl py-2">
              <input
                ...
                className=" appearance-none w-5 h-5 mr-5 rounded-full border-2 border-base-100 checked:bg-base-100"
              />
              <label htmlFor="collaborative" className="mr-8">
                Collaborative
              </label>
            </div>
          </div>
          <h2 className="mt-12 bg-white rounded-t-3xl p-3 text-center text-black w-3/4">
          ...
          />
          <h2 className="mt-12 bg-white rounded-xl p-3 text-center text-black w-3/4">
            *Is your book already complete and ready for publication?
          </h2>
          <div className="flex flex-col items-center justify-center mt-6 text-center w-full">
          ...
          <h2 className="mt-12 bg-white rounded-xl p-3 text-center text-black w-3/4">
            *Is your story a series or a one shot?
          </h2>
          <div className="flex flex-col items-center justify-center mt-6 text-center w-full">
            <div className="bg-white pl-4 text-black flex items-center rounded-3xl w-1/3 py-2">
              <input
            ...
            <div className="bg-white pl-4 text-black flex items-center rounded-3xl w-1/3 py-2 mt-6">
              <input
                ...
                className="appearance-none w-5 h-5 mr-3 rounded-full border-2 border-base-100 checked:bg-base-100"
              />
              <label htmlFor="oneShot" className="ml-0">
                A One Shot
              </label>
            </div>
          </div>
          <h2 className="mt-12 bg-white rounded-t-3xl p-3 text-center text-black w-3/4">
            *If it&apos;s a series, how many books do you have planned, and how
            long do you plan the series to be?
          </h2>
          <textarea
            id="seriesPlan"
            name="idea"
          ...
          <Turnstile
            ...
            onSuccess={() => setCloudflareStatus("solved")}
          />
