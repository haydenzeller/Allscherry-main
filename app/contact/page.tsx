    ...
    return (
        <main className="flex min-h-screen flex-col bg-base-100">
            ...
            <div className="flex flex-col text-center mt-14 ml-12 mr-12 items-center justify-center">
                <h1>Allscherry was founded by Eric Olcsvary, as a way to bring artists together, and to... well, make art!</h1>
                ...
                <section className="flex flex-col justify-center items-center text-center mt-14 w-full">
                    <ContactForm/>
                </section>
            </div>
            <Footer/>
