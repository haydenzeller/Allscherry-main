                ...
                <section className="flex flex-col justify-center items-center text-center mx-1 mt-14 gap-5">
                    <div className="flex flex-row items-center justify-center gap-3">
                        <div className="w-1/2 flex flex-col justify-center">
                            ...
                            <Link href="/applications" className="bg-primary text-black p-2 px-1 mt-4 border-b-accent border-b-4 rounded-full block w-34 mx-1 text-center active:mt-5 active:border-0">Let&apos;s make a book!</Link>
                        </div>
                    ...
                    <div className="flex flex-row-reverse items-center justify-center gap-3">
                        <div className="w-1/2 flex flex-col justify-center">
                            ...
                            <Link href="/applications" className="bg-primary text-black p-2 px-1 mt-4 border-b-accent border-b-4 rounded-full block w-34 mx-1 text-center active:mt-5 active:border-0">Be included here!</Link>
                        </div>
                        <div className="flex justify-center w-1/2">
                    ...
                    <div className="flex flex-row items-center justify-center gap-3">
                        <div className="w-1/2 flex flex-col justify-center">
                            ...
                            <Link href="/applications" className="bg-primary text-black p-2 px-1 mt-4 border-b-accent border-b-4 rounded-full block w-34 mx-1 text-center active:mt-5 active:border-0">Let&apos;s hear it!</Link>
                        </div>
                        <div className="flex justify-center w-1/2">
