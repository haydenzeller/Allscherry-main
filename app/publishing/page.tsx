...
export const metadata: Metadata = {
  ...
  description:
    "AllsCherry Publishing Page - AllsCherry is primarily a comic book brand! Want to publish yourself, but don't have a printer? Need some business cards? A poster? Brochures?! Don't worry, we know a guy ;)",
  keywords: [
    "AllsCherry",
    "Home",
    "AllsCherry Home",
      ...
      <section className="flex flex-col bg-base-100 lg:text-xl items-center justify-center w-full">
        ...
        <section className="flex bg-base-200 lg:w-1/2 flex-col items-center justify-center mt-6 mx-5 rounded-3xl">
          ...
          <div className="mt-2 lg:w-3/4">
            ...
            <div className="rounded-xl text-black p-3 px-5 m-3 bg-[#FFDBDB]">
              <h2>
                AllsCherry works with many types of artists; building teams for
                projects or for collaborative works!
              </h2>
            </div>
          </div>
          <div className="mt-2 lg:w-3/4">
            ...
            <div className="rounded-xl text-black p-3 px-5 m-3 bg-[#FFDBDB]">
              <h2>
                Creating something new, and truly yours, is what makes for
        ...
        <section className="flex flex-col lg:flex-row justify-center items-center text-center mx-1 mt-14 gap-5">
          <div className="flex flex-row lg:flex-col lg:w-3/4 items-center justify-center gap-3">
            <div className="w-1/2 flex flex-col justify-center">
              ...
              <Link
                href="/applications"
                className="bg-primary text-black p-2 px-1 mt-4 border-b-accent border-b-4 rounded-full block w-34 mx-1 text-center active:mt-5 active:border-0"
              >
                Let&apos;s make a book!
              </Link>
            </div>
            <div className="flex justify-center w-1/2">
              <h2 className="text-md text-center border border-base-200 rounded-3xl p-3">
                AllsCherry believes if someone tells you how to make your art,
                then it&apos;s not your art!
                <br />
                <br />
                We make your ideas come to life how you want it. Our CEO and
                Chief Editor personally bring you from Step 0 to a book in hand
                with our Publication Service!
              </h2>
            </div>
          </div>
          <div className="flex flex-row-reverse lg:w-3/4 lg:flex-col items-center justify-center gap-3">
            ...
            <div className="flex justify-center w-1/2">
              <h2 className="text-md text-center border border-base-200 rounded-3xl p-3">
                AllsCherry continuously builds it&apos;s community to include
                all kinds of creative minds.
                <br />
                <br />
                We pride ourselves in our collaborative Annual Anthology and
                Stubby Stories books to bring together beginner and veteran
                artists!
              </h2>
            </div>
          </div>
          <div className="flex flex-row lg:flex-col lg:w-3/4 items-center justify-center gap-3">
            ...
            <div className="flex justify-center w-1/2">
              <h2 className="text-md text-center border border-base-200 rounded-3xl p-3">
                Originality in art is a core aspect at AllsCherry, not only for
                the sake of the artists here, but for the audience too!
                <br />
                <br />
                Everybody loves a new and captivating story, so let&apos;s help
                you plan yours out, we&apos;d love to hear it!
              </h2>
            </div>
          </div>
        </section>
        <section className="flex flex-col justify-center items-center text-center mx-1 mt-14 gap-5">
          ...
          <div className="flex flex-col items-center justify-center mx-1 mt-6">
            ...
            <Link
              href="/applications"
              className="bg-primary text-black p-2 px-14 mt-6 border-b-accent border-b-4 rounded-full block w-34 text-center active:mt-5 active:border-0"
            >
              Apply Here!
            </Link>
          </div>
